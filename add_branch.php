...
$sql="INSERT INTO `branch`(`branch_name`, `contact_person_name`, `contact_person_no`, `contact_person_email_id`, `address`, `customer_care_no`, `sales_no`, `support_no`, `created_on`, `created_by`) VALUES ('".$branch_name."','".$contact_person_name."','".$contact_person_no."','".$contact_person_email_id."','".$address."','".$customer_care_no."','".$sales_no."','".$support_no."','".$con."','".$cby."')";
...
<head>
	...
	<title><?php echo $gset_row['title'];?> | Admin Add Branch</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Add Branch</h2>
...
<div class="form-group">
	...
	<div class="col-sm-4">
	<input type="text" id="contact_person_no" name="contact_person_no" class="form-control" onkeypress="return isNumber(event);" maxlength="12">
	...
	<div class="col-sm-4">
	<input type="text" id="contact_person_email_id" name="contact_person_email_id" class="form-control">
...
<div class="form-group">
	...
	<div class="col-sm-4">
	<input type="text" id="customer_care_no" name="customer_care_no" class="form-control" onkeypress="return isNumber(event);" maxlength="12">
...
<div class="form-group">
	...
	<div class="col-sm-4">
	<input type="text" id="sales_no" name="sales_no" class="form-control" onkeypress="return isNumber(event);" maxlength="12">
	<span id="sales_no_err" class="text-danger"></span>
	</div>

	<label class="col-sm-2 control-label">Support No<span style="color:red">*</span></label>
	<div class="col-sm-4">
	<input type="text" id="support_no" name="support_no" class="form-control" onkeypress="return isNumber(event);" maxlength="12">
