...
$sql="UPDATE `tag` SET `branch_id`='".$branch_id."',`tag`='".$tag."',`modified_on`='".$mon."',`modified_by`='".$mby."' WHERE `tag_id`='".$tag_id."'";
...
<head>
	...
	<title><?php echo $gset_row['title'];?> | Edit Tag</title>
...
$bcat_qry ="SELECT * FROM tag where tag_id='".$id."'";
...
<form method="post" class="form-horizontal" enctype="multipart/form-data" onsubmit="return tag_validataion()">
<input type="hidden" id="tag_id" name="tag_id" value="<?php echo $bcat_row['tag_id'];?>">
<div class="form-group">
	...
	<div class="col-sm-4">
		<input type="text" id="tag" name="tag" class="form-control" value="<?php echo $bcat_row['tag'];?>">
	<span id="tag_err" class="text-danger"></span>
	</div>
</div>
											...
											<div class="form-group">
												<div class="col-sm-8 col-sm-offset-2">
													<a href="tag.php"><button class="btn btn-default" type="button">Cancel</button></a>
