...
$sql="UPDATE `role` SET `branch_id`='".$branch_id."',`role_name`='".$role_name."',`modified_on`='".$mon."',`modified_by`='".$mby."' WHERE `role_id`='".$role_id."'";
...
<head>
	...
	<title><?php echo $gset_row['title'];?> | Admin Edit Role</title>
...
$bcat_qry ="SELECT * FROM role where role_id='".$id."'";
...
<input type="hidden" id="role_id" name="role_id" value="<?php echo $bcat_row['role_id'];?>">
<div class="form-group">
	...
	<select name="branch_id" id="branch_id" class="form-control">
		<option value=''>Select Branch</option>
	   	...
	   	<option value="<?php echo $row['branch_id'];?>" <?php echo $row['branch_id']==$bcat_row['branch_id']?'selected':'';?>><?php echo $row['branch_name'];?></option>
	   	<?php }?>
	</select>
	...
	<div class="col-sm-4">
	<input type="text" id="role_name" name="role_name" class="form-control" value="<?php echo $bcat_row['role_name'];?>">
