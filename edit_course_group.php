...
$sql="UPDATE `course_group` SET `branch_id`='".$branch_id."',`course_group`='".$course_group."',`modified_on`='".$mon."',`modified_by`='".$mby."' WHERE `course_group_id`='".$course_group_id."'";
$user_result = mysqli_query($mysqli, $sql);
if($user_result)
{
$msg="Course Group Updated successfully";
...
<head>
	...
	<title><?php echo $gset_row['title'];?> | Edit Course Group</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Edit Course Group</h2>
<?php $id=intval($_GET['id']);
$bcat_qry ="SELECT * FROM course_group where course_group_id='".$id."'";
...
<form method="post" class="form-horizontal" enctype="multipart/form-data" onsubmit="return course_group_validataion()">
<input type="hidden" id="course_group_id" name="course_group_id" value="<?php echo $bcat_row['course_group_id'];?>">
<div class="form-group">
	...
	<label class="col-sm-2 control-label">Course Group<span style="color:red">*</span></label>
	<div class="col-sm-4">
		<input type="text" id="course_group" name="course_group" class="form-control" value="<?php echo $bcat_row['course_group'];?>">
	<span id="course_group_err" class="text-danger"></span>
	</div>
</div>
											...
											<div class="form-group">
												<div class="col-sm-8 col-sm-offset-2">
													<a href="course_group.php"><button class="btn btn-default" type="button">Cancel</button></a>
...
function course_group_validataion()
{
   var err = 0;
   ...
   if (course_group == '') {
      $('#course_group_err').html('Enter Course Group!');
      err++;
   }
   else {
      $('#course_group_err').html('');
   }
