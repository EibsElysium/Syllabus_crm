...
$sql="UPDATE `job_role` SET `branch_id`='".$branch_id."',`job_role`='".$job_role."',`modified_on`='".$mon."',`modified_by`='".$mby."' WHERE `job_role_id`='".$job_role_id."'";
$user_result = mysqli_query($mysqli, $sql);
if($user_result)
{
$msg="Job Role Updated successfully";
...
<head>
	...
	<title><?php echo $gset_row['title'];?> | Edit Job Role</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Edit Job Role</h2>
<?php $id=intval($_GET['id']);
$bcat_qry ="SELECT * FROM job_role where job_role_id='".$id."'";
...
<form method="post" class="form-horizontal" enctype="multipart/form-data" onsubmit="return job_role_validataion()">
<input type="hidden" id="job_role_id" name="job_role_id" value="<?php echo $bcat_row['job_role_id'];?>">
<div class="form-group">
	...
	<div class="col-sm-4">
		<input type="text" id="job_role" name="job_role" class="form-control" value="<?php echo $bcat_row['job_role'];?>">
	<span id="job_role_err" class="text-danger"></span>
	</div>
</div>
											...
											<div class="form-group">
												<div class="col-sm-8 col-sm-offset-2">
													<a href="job_role.php"><button class="btn btn-default" type="button">Cancel</button></a>
...
function job_role_validataion()
{
   ...
   if (job_role == '') {
      $('#job_role_err').html('Enter Job Role!');
      err++;
   }
   else {
      $('#job_role_err').html('');
