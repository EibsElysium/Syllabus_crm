...
$sql="INSERT INTO `course_group`(`branch_id`, `course_group`, `created_on`, `created_by`) VALUES ('".$branch_id."','".$course_group."','".$con."','".$cby."')";
$user_result = mysqli_query($mysqli, $sql);
if($user_result)
{
$msg="Course Group Added successfully";
...
<head>
	...
	<title><?php echo $gset_row['title'];?> | Add Course Group</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Add Course Group</h2>
...
<div class="form-group">
	...
	<div class="col-sm-4">
		<input type="text" id="course_group" name="course_group" class="form-control">
