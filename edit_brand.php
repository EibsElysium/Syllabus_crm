...
$sql="UPDATE `brand` SET `branch_id`='".$branch_id."',`brand`='".$brand."',`modified_on`='".$mon."',`modified_by`='".$mby."' WHERE `brand_id`='".$brand_id."'";
...
<head>
	...
	<title><?php echo $gset_row['title'];?> | Edit Brand</title>
...
$bcat_qry ="SELECT * FROM brand where brand_id='".$id."'";
...
<form method="post" class="form-horizontal" enctype="multipart/form-data" onsubmit="return brand_validataion()">
<input type="hidden" id="brand_id" name="brand_id" value="<?php echo $bcat_row['brand_id'];?>">
<div class="form-group">
	...
	<div class="col-sm-4">
		<input type="text" id="brand" name="brand" class="form-control" value="<?php echo $bcat_row['brand'];?>">
	<span id="brand_err" class="text-danger"></span>
	</div>
</div>
											...
											<div class="form-group">
												<div class="col-sm-8 col-sm-offset-2">
													<a href="brand.php"><button class="btn btn-default" type="button">Cancel</button></a>
