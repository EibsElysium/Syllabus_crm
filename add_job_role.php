...
$sql="INSERT INTO `job_role`(`branch_id`, `job_role`, `created_on`, `created_by`) VALUES ('".$branch_id."','".$job_role."','".$con."','".$cby."')";
...
<head>
	...
	<title><?php echo $gset_row['title'];?> | Add Job Role</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Add Job Role</h2>
