...
$sql="UPDATE `course_type` SET `branch_id`='".$branch_id."',`course_type`='".$course_type."',`modified_on`='".$mon."',`modified_by`='".$mby."' WHERE `course_type_id`='".$course_type_id."'";
...
<head>
	...
	<title><?php echo $gset_row['title'];?> | Edit Course Type</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Edit Course Type</h2>
<?php $id=intval($_GET['id']);
$bcat_qry ="SELECT * FROM course_type where course_type_id='".$id."'";
...
<input type="hidden" id="course_type_id" name="course_type_id" value="<?php echo $bcat_row['course_type_id'];?>">
<div class="form-group">
	...
	<div class="col-sm-4">
		<input type="text" id="course_type" name="course_type" class="form-control" value="<?php echo $bcat_row['course_type'];?>">
